...
python /tmp/make_dly_obs_table_standalone.py hampt_rd_data.sqlite nor_daily_observations_standalone.csv
python /tmp/by_event_for_model.py flood_events.csv nor_daily_observations_standalone.csv for_model_avgs.csv
